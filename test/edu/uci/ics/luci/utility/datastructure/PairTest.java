...
public class PairTest {
	...
	public void testCompareTo() {
		...
		assertEquals(p13.hashCode(),p13.hashCode());
		assertTrue(!p13.equals(p1));
		assertNotEquals(p13.hashCode(),p1.hashCode());
		assertTrue(!p1.equals(p13));
		assertNotEquals(p1.hashCode(),p13.hashCode());
		
		Pair<Double, String> p14 = new Pair<Double,String>(null,null);
		assertTrue(p13.equals(p14));
		assertEquals(p14.hashCode(),p14.hashCode());
	}
