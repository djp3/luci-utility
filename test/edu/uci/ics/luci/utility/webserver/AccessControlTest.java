...
public class AccessControlTest extends AccessControl{
	...
	public AccessControlTest() {
		super();
		GlobalsForTesting.reset( "testSupport/AccessControlTest.log4j.xml");
	...
	public void testLoadConfiguration() {
		try{
			setDefaultFilename("testSupport/AccessControlTest.properties");
			loadConfiguration();
		}
		catch(Exception e){
	...
	public void testBadGuyTesting3() {
		...
		setBadGuyTest(newBadGuyTest);
		try {
			setDefaultFilename("testSupport/AccessControlTest2.properties");
			loadConfiguration();
			fail("This should throw an exception for letting a bad guy through");
		} catch (ConfigurationException e) {
			fail("Failed to load test.properties");
	...
	public void testAllowSource3() {
		...
		setDefaultFilename("testSupport/AccessControlTest4.properties");
	...
	public void testBadConfiguration() {
		try{
			setDefaultFilename("testSupport/doesnotexist.properties");
			loadConfiguration();
	...
	public void testCacheExpiring() {
		...
		assertTrue(cacheExpired());
		setDefaultFilename("testSupport/AccessControlTest3.properties");
		/*Force cache reload*/
